...
class AdminController extends Controller
{
	...
	//	echo($enrollmentid);exit();
		...
		//QUERU WRONG HERE
		$data = DB::select("SELECT *,MAX(scores) as mscores FROM `assignment_work` WHERE enrollments_id = $enrollmentid GROUP BY assignments_id,enrollments_id ORder by assignments_id ASC");
		$asn = Assignments::all();
