            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <table class="table table-striped task-table">
                    ...
                    <tbody>
                        ...
                        @foreach($userdetails as $euler)
                          
                                <td class="table-text">
                                    <div>{{$euler->users->first()->pinid}}</div>
                                </td>
                                ...
                                <td class="table-text">
                                    <div>{{$euler->users->first()->name}}</div>
                                </td>
                               <td class="table-text">
                                    <div>{{$euler}}</div>
                                </td>
                               <td>
                                  ...
                                  <a href="{{ route('admin.assignments.show', $euler->id) }}" class="label label-danger">Drop Assignment</a>   
